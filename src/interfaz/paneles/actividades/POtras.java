...
public class POtras extends javax.swing.JPanel {

    NuevaActividad na;

    public POtras(NuevaActividad na, String date) {
        this.na = na;
        initComponents();       
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(buttonHover1, javax.swing.GroupLayout.DEFAULT_SIZE, 277, Short.MAX_VALUE)
                .addContainerGap())
        );
