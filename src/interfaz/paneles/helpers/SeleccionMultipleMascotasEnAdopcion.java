...
public class SeleccionMultipleMascotasEnAdopcion extends javax.swing.JFrame {
    ...
    public SeleccionMultipleMascotasEnAdopcion(List<Animal> m, PAdoptante pa) {
        this.pa = pa;
        mascotasS = m;
        initComponents();
    ...
    private void BtnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGuardar1ActionPerformed
        pa.setMascotas(mascotasSeleccionadas);
        this.dispose();
